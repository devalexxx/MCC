...
TEST_SUITE("Position")
{
    ...
    TEST_CASE("FloatCoordToVoxelCoord")
    {
        ...
        std::vector<std::tuple<glm::vec3, glm::ivec2, glm::uvec3>> data {
            { {  0  , 126  ,   0}, { 0,  0}, { 0, 126,  0} },
            { {  0  , 126.5,   0}, { 0,  0}, { 0, 126,  0} },
            { { 30  , 126  ,   0}, { 0,  0}, {30, 126,  0} },
            { {  0  , 126  ,  30}, { 0,  0}, { 0, 126, 30} },
            { { 30  , 126  ,  30}, { 0,  0}, {30, 126, 30} },
            { {  0  ,   0  ,   0}, { 0,  0}, { 0,   0,  0} },
            { { 30.5,   0  ,   0}, { 0,  0}, {30,   0,  0} },
            { { 31  ,   0  ,   0}, { 1,  0}, { 0,   0,  0} },
            { { 31.5,   0  ,   0}, { 1,  0}, { 0,   0,  0} },
            { { 32  ,   0  ,   0}, { 1,  0}, { 1,   0,  0} },
            { {-32  , 110  , -10}, {-2, -1}, {30, 110, 21} },
            { {-1   ,   0  ,   0}, {-1,  0}, {30,   0,  0} },
            { {-31  ,   0  ,   0}, {-1,  0}, { 0,   0,  0} },
            { {-31.5,   0  ,   0}, {-2,  0}, {30,   0,  0} },
            { {-32  ,   0  ,   0}, {-2,  0}, {30,   0,  0} },
    ...
    TEST_CASE("ChunkCoordToFloatCoord")
    {
        ...
        std::vector<std::tuple<glm::vec3, glm::ivec2>> data {
            {{  0,   0,   0}, { 0,  0}},
            {{ 31,   0,   0}, { 1,  0}},
            {{-62,   0, -31}, {-2, -1}},
            {{-31 ,  0,   0}, {-1,  0}},
    ...
    TEST_CASE("LocalPosE")
    {
        ...
        LocalPosE a(0.5, 1.44, 0.23);
        LocalPosE b(0.5, 1.44, 0.23);
    ...
    TEST_CASE("Position<WorldSpace, EntityCoord>")
    {
        ...
        WorldPosE a({10, -10}, {0.5, 1.22, 0.22});
